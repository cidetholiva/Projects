...
--
-- Temporary view structure for view `borough_fatality_rate`
--

DROP TABLE IF EXISTS `borough_fatality_rate`;
/*!50001 DROP VIEW IF EXISTS `borough_fatality_rate`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `borough_fatality_rate` AS SELECT 
 1 AS `borough`,
 1 AS `total_collisions`,
 1 AS `total_fatalities`,
 1 AS `fatality_rate`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `borough_time_of_day_impact`
--

DROP TABLE IF EXISTS `borough_time_of_day_impact`;
/*!50001 DROP VIEW IF EXISTS `borough_time_of_day_impact`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `borough_time_of_day_impact` AS SELECT 
 1 AS `borough`,
 1 AS `time_of_day`,
 1 AS `total_collisions`,
 1 AS `total_casualties`,
 1 AS `avg_casualties_per_collision`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `collisions_by_borough_date`
--

DROP TABLE IF EXISTS `collisions_by_borough_date`;
/*!50001 DROP VIEW IF EXISTS `collisions_by_borough_date`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `collisions_by_borough_date` AS SELECT 
 1 AS `borough`,
 1 AS `crash_date`,
 1 AS `TotalCollisions`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `collisions_per_street`
--

DROP TABLE IF EXISTS `collisions_per_street`;
/*!50001 DROP VIEW IF EXISTS `collisions_per_street`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `collisions_per_street` AS SELECT 
 1 AS `main_street_name`,
 1 AS `total_collisions`,
 1 AS `total_injuries`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `holiday_collisions`
--

DROP TABLE IF EXISTS `holiday_collisions`;
/*!50001 DROP VIEW IF EXISTS `holiday_collisions`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `holiday_collisions` AS SELECT 
 1 AS `collision_id`,
 1 AS `crash_date`,
 1 AS `crash_time`,
 1 AS `borough`,
...
--
-- Final view structure for view `borough_fatality_rate`
--
...
/*!50001 VIEW `borough_fatality_rate` AS select `l`.`borough` AS `borough`,count(`c`.`collision_id`) AS `total_collisions`,sum(`c`.`number_of_persons_killed`) AS `total_fatalities`,(sum(`c`.`number_of_persons_killed`) / count(`c`.`collision_id`)) AS `fatality_rate` from (`collision` `c` join `location` `l` on((`c`.`location_id` = `l`.`location_id`))) group by `l`.`borough` order by `fatality_rate` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `borough_time_of_day_impact`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `borough_time_of_day_impact` AS select `l`.`borough` AS `borough`,(case when (hour(`c`.`crash_time`) between 0 and 6) then 'Night' when (hour(`c`.`crash_time`) between 7 and 12) then 'Morning' when (hour(`c`.`crash_time`) between 13 and 18) then 'Afternoon' else 'Evening' end) AS `time_of_day`,count(`c`.`collision_id`) AS `total_collisions`,sum((((((((`c`.`number_of_persons_injured` + `c`.`number_of_persons_killed`) + `c`.`number_of_pedestrians_injured`) + `c`.`number_of_pedestrians_killed`) + `c`.`number_of_cyclists_injured`) + `c`.`number_of_cyclists_killed`) + `c`.`number_of_motorists_injured`) + `c`.`number_of_motorists_killed`)) AS `total_casualties`,avg((((((((`c`.`number_of_persons_injured` + `c`.`number_of_persons_killed`) + `c`.`number_of_pedestrians_injured`) + `c`.`number_of_pedestrians_killed`) + `c`.`number_of_cyclists_injured`) + `c`.`number_of_cyclists_killed`) + `c`.`number_of_motorists_injured`) + `c`.`number_of_motorists_killed`)) AS `avg_casualties_per_collision` from (`collision` `c` join `location` `l` on((`c`.`location_id` = `l`.`location_id`))) group by `l`.`borough`,`time_of_day` order by `l`.`borough`,`avg_casualties_per_collision` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `collisions_by_borough_date`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `collisions_by_borough_date` AS select `location`.`borough` AS `borough`,`collision`.`crash_date` AS `crash_date`,count(`collision`.`collision_id`) AS `TotalCollisions` from (`collision` join `location` on((`collision`.`location_id` = `location`.`location_id`))) group by `location`.`borough`,`collision`.`crash_date` order by `TotalCollisions` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `collisions_per_street`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `collisions_per_street` AS select `streets`.`main_street_name` AS `main_street_name`,(select count(0) from `collision` where ((`collision`.`on_street_name` = `streets`.`main_street_name`) or (`collision`.`cross_street_name` = `streets`.`main_street_name`) or (`collision`.`off_street_name` = `streets`.`main_street_name`))) AS `total_collisions`,sum(`collision`.`number_of_persons_injured`) AS `total_injuries` from ((select `collision`.`on_street_name` AS `main_street_name` from `collision` union select `collision`.`cross_street_name` AS `cross_street_name` from `collision` union select `collision`.`off_street_name` AS `off_street_name` from `collision`) `streets` join `collision` on((`streets`.`main_street_name` in (`collision`.`on_street_name`,`collision`.`cross_street_name`,`collision`.`off_street_name`)))) group by `streets`.`main_street_name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `holiday_collisions`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `holiday_collisions` AS select `c`.`collision_id` AS `collision_id`,`c`.`crash_date` AS `crash_date`,`c`.`crash_time` AS `crash_time`,`l`.`borough` AS `borough`,`c`.`number_of_persons_injured` AS `number_of_persons_injured`,`c`.`number_of_persons_killed` AS `number_of_persons_killed` from (`collision` `c` join `location` `l` on((`c`.`location_id` = `l`.`location_id`))) where (`c`.`crash_date` in ('2024-01-01','2024-01-15','2024-05-27','2024-06-19','2024-07-04','2024-09-02','2024-10-14','2024-11-11','2024-11-28','2024-11-29','2024-12-25')) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-08-16 22:25:03
